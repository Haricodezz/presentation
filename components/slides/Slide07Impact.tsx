...
export default function Slide09Impact({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div
      className="w-full h-full bg-[#020503] text-white overflow-hidden relative"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-between gap-6">
          ...
          {/* Comparison Blocks */}
          <div className="flex items-center justify-between rounded-2xl border border-white/5 bg-white/[0.01] p-6 relative">
            ...
            >
              <span className="uppercase font-mono text-center text-green-400" style={{ fontSize: "10px", letterSpacing: "2px", wordSpacing: "-2px", marginBottom: "8px" }}>PREVIOUS STOCK</span>
              <span className="font-bold text-white tabular-nums" style={{ fontSize: "32px", lineHeight: 1 }}>1,250</span>
              <span className="text-white/40 mt-1" style={{ fontSize: "11px" }}>tCO₂</span>
            </motion.div>
            ...
            >
              <span className="uppercase font-mono text-center text-orange-400" style={{ fontSize: "10px", letterSpacing: "2px", wordSpacing: "-2px", marginBottom: "8px" }}>CURRENT STOCK</span>
              <span className="font-bold text-white tabular-nums" style={{ fontSize: "32px", lineHeight: 1 }}>1,150</span>
              <span className="text-white/40 mt-1" style={{ fontSize: "11px" }}>tCO₂</span>
            </motion.div>
          ...
          {/* Animated Flow Steps */}
          <div className="rounded-2xl border border-white/5 bg-white/[0.01] p-6 flex items-center justify-between relative overflow-hidden">
            <motion.div
              animate={{ left: ["-10%", "110%"] }}
            ...
            {flowSteps.map((step, i) => (
              ...
              >
                <div className="w-10 h-10 rounded-full border border-white/10 bg-[#040a06] flex items-center justify-center">
                  <step.icon className="w-4 h-4 text-white/60" />
                </div>
                <span className="text-center text-white/60 uppercase font-mono" style={{ fontSize: "9px", letterSpacing: "1px", maxWidth: "80px" }}>
                  {step.label}
                </span>
              </motion.div>
            ))}
            <div className="absolute top-[42px] left-10 right-10 h-[1px] bg-white/5 -z-10" />
          </div>
        ...
        <motion.div
          ...
          className="border border-white/10 bg-[#020503] flex flex-col overflow-hidden relative"
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 bg-white/[0.02]" style={{ height: "40px", padding: "0 20px" }}>
            ...
            <span className="text-[9px] text-white/30 font-mono">SCENARIO {scenario}</span>
          </div>
          ...
          <div className="flex flex-col flex-1 relative" style={{ padding: "4px 20px 16px" }}>
            <AnimatePresence mode="wait">
              {scenario === 1 ? (
                ...
                >
                  <div className="flex justify-between items-center" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", fontWeight: 400, fontFamily: "monospace" }}>Buffer Available:</span>
                    <span style={{ fontSize: "13px", fontWeight: 700, color: "#ffffff", fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>180</span>
                  </div>
                  <div className="flex justify-between items-center" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", fontWeight: 400, fontFamily: "monospace" }}>Req. Deduction:</span>
                    <span style={{ fontSize: "13px", fontWeight: 700, color: "#ff5555", fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>-100</span>
                  </div>
                  <div className="flex justify-between items-center" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", fontWeight: 400, fontFamily: "monospace" }}>Remaining Buffer:</span>
                    <span style={{ fontSize: "13px", fontWeight: 700, color: "#00C896", fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>80</span>
                  </div>
                  <div className="mt-auto pt-4">
                    <div className="flex items-center justify-between rounded" style={{ background: "rgba(34,197,94,0.08)", border: "1px solid rgba(34,197,94,0.2)", padding: "10px 14px" }}>
                      <span style={{ fontSize: "10px", letterSpacing: "2px", color: "rgba(0,200,150,0.7)", fontFamily: "monospace", wordSpacing: "-2px" }} className="uppercase">STATUS</span>
                      <span className="flex items-center gap-1.5" style={{ fontSize: "12px", fontWeight: 700, color: "#00C896", letterSpacing: "1px", fontFamily: "monospace" }}>
                ...
                >
                  <div className="flex justify-between items-center" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", fontWeight: 400, fontFamily: "monospace" }}>Buffer Available:</span>
                    <span style={{ fontSize: "13px", fontWeight: 700, color: "#ffffff", fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>40</span>
                  </div>
                  <div className="flex justify-between items-center" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", fontWeight: 400, fontFamily: "monospace" }}>Req. Deduction:</span>
                    <span style={{ fontSize: "13px", fontWeight: 700, color: "#ff5555", fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>-100</span>
      ...
      >
        <span className="font-black uppercase" style={{ fontSize: "clamp(18px, 2vw, 24px)", fontWeight: 900, letterSpacing: "2px", color: "#ffffff", wordSpacing: "-2px" }}>
          CARBON INTEGRITY IS NOT A ONE-TIME CHECK.
        </span>
        <span className="font-black uppercase" style={{ fontSize: "clamp(18px, 2vw, 24px)", fontWeight: 900, letterSpacing: "2px", color: "#00C896", wordSpacing: "-2px", textShadow: "0 0 20px rgba(34,197,94,0.4)" }}>
